...
console.log(5 == 5);
// console.log(5 == "4");  imaju istu vrednost, ali im je razlicit tip
...
console.log(5 === "5" || "sreda"); // false
console.log(5 === "sreda" || "Sreda"); // true

// ! logicko not => Vraca boolean. Koji ce da bude suprotna vrednosti od promenljive.
console.log(!isSunny);
